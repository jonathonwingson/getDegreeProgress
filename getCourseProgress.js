...
const studentCourseCodes = [
    ...
    // progrmmeId 2
    "COMP1600", "COMP1601", "COMP1602", "COMP1603", //12L1 cs/it core
    ...
    "COMP3601", "COMP3602", "COMP3603","COMP3605",  //12 advance elective
    "COMP3606", "COMP3607", "INFO3610", "COMP2606",//15 advance elecetive Computer Science/Economics/Information Technology/Mathematics/Management
...
const programmeCourses = [
    ...
    { programmeId: 2, courseCode: "COMP2606", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3601", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3602", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3603", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3605", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3606", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3607", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3608", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3609", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3610", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3611", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3612", typeId: 8 },
    { programmeId: 2, courseCode: "COMP3613", typeId: 8 },
    { programmeId: 2, courseCode: "INFO2602", typeId: 8 },
    { programmeId: 2, courseCode: "INFO2604", typeId: 8 },
    { programmeId: 2, courseCode: "INFO2605", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3600", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3605", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3604", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3606", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3607", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3608", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3609", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3610", typeId: 8 },
    { programmeId: 2, courseCode: "INFO3611", typeId: 8 },
...
function getDegreeProgress(programmeId, studentCourseCodes, courses, programmeCreditRequirements, programmeCourses) {
    ...
    for( let creditType in creditRequirements){
        ...
        let typeObj = typeTable.find((type) => type.type === creditType);
        ...
        for (let i = 0; i < studentCourseCodes.length; i++){
            ...
            if(programmeCourse && !completedCourses.includes(programmeCourse.courseCode)){
                ...
                // console.log("both: ", programmeCourse);
            }
        }
